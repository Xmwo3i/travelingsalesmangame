...
// Add the button to the grid pane
        ...
        Image image = new Image(getClass().getResourceAsStream("/com/example/travelingsalesmangame/Game Icon.png"));
        System.out.println(getClass().getResource("/com/example/travelingsalesmangame/Game Icon.png"));
    ...
    private void displayWeapons(List<Weapon> weapons, String marketName) {
        ...
        Image image = new Image(getClass().getResourceAsStream("/com/example/travelingsalesmangame/market.png"));
