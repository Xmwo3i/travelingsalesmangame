...
import static com.example.travelingsalesmangame.Loot.xLootCollected;
import static com.example.travelingsalesmangame.Loot.yLootCollected;
import static javafx.scene.paint.Color.*;
import static com.example.travelingsalesmangame.Loot.*;
import static com.example.travelingsalesmangame.TravelingSalesmanGame.visitedHouses;
    ...
    private void updatePlayerPosition(Player player) {
        ...
        if (player == player1){
            if (player1.getXCoordinate() == 5 && player1.getYCoordinate() == 4) {
                TravelingSalesmanGame.castleQuestion(player1);
            }
        }
        if (player == player2){
            if (player2.getXCoordinate() == 5 && player2.getYCoordinate() == 4) {
                TravelingSalesmanGame.castleQuestion(player2);
            }
        }
